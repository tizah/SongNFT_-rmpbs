...
export type ContractContext = EthersContractContextV5<
  DroptokenAbi,
  DroptokenAbiMethodNames,
  DroptokenAbiEventsContext,
  DroptokenAbiEvents
>;
...
export type DroptokenAbiEvents =
  | 'Approval'
  | 'OwnershipTransferred'
  | 'Paused'
  | 'Transfer'
  | 'Unpaused';
export interface DroptokenAbiEventsContext {
...
export type DroptokenAbiMethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
...
export interface DroptokenAbi {
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   * Type: constructor
   * @param _playlistToken Type: address, Indexed: false
   */
  'new'(
    _playlistToken: string,
